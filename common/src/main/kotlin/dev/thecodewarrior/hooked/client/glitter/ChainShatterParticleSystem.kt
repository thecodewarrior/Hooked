...
object ChainShatterParticleSystem: ParticleSystem(Identifier.of(Hooked.MOD_ID, "chain_shatter")) {
    override fun configure() {
        ...
        renderModules.add(
            SpriteRenderModule.build(
                SpriteRenderOptions.build(Identifier.of(Hooked.MOD_ID, "textures/glitter/bar.png"))
                    .worldLight(true)
                    .diffuseLight(true)
                    .build(),
                position
