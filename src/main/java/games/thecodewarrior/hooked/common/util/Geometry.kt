...
import games.thecodewarrior.hooked.shade.quickhull3d.Point3d
import games.thecodewarrior.hooked.shade.quickhull3d.QuickHull3D
...
data class Polygon(val points: List<Vec3d>): Constraint {
    ...
    override fun constrain(point: Vec3d): Vec3d {
        ...
        return edges.map { it.constrain(point) }.minBy { (it - point).lengthSquared() }!!
    }
