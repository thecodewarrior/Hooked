...
abstract class HookRenderer<T: HookController>: IForgeRegistryEntry.Impl<HookRenderer<HookController>>() {
    ...
    companion object {
        @JvmStatic
        lateinit var REGISTRY: IForgeRegistry<HookRenderer<HookController>>
    }
}